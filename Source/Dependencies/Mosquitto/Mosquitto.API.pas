...
type
    ...
    Tmosquitto_message = packed record
        mid: cint;
        topic: PAnsiChar;
        payload: pointer;
        payloadlen: cint;
 ...
 *}
function mosquitto_new(const id: PAnsiChar; clean_session: cbool; obj: Pointer): Pmosquitto; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_reinitialise(mosq: Pmosquitto; const id: PAnsiChar; clean_session: cbool; obj: Pointer): cint; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_will_set(mosq: Pmosquitto; const topic: PAnsiChar; payloadlen: cint; const payload: pointer; qos: cint; retain: cbool): cint; cdecl; external libmosq_NAME;
 ...
 * 	MOSQ_ERR_NOMEM -   if an out of memory condition occurred.
 *}
function mosquitto_username_pw_set(mosq: Pmosquitto; const username: PAnsiChar; const password: PAnsiChar): cint; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_connect(mosq: Pmosquitto; const host: PAnsiChar; port: cint; keepalive: cint): cint; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_connect_bind(mosq: Pmosquitto; const host: PAnsiChar; port: cint; keepalive: cint; const bind_address: PAnsiChar): cint; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_connect_async(mosq: Pmosquitto; const host: PAnsiChar; port: cint; keepalive: cint): cint; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_connect_bind_async(mosq: Pmosquitto; const host: PAnsiChar; port: cint; keepalive: cint; const bind_address: PAnsiChar): cint; cdecl; external libmosq_NAME;
 ...
 * 	<mosquitto_connect_async>, <mosquitto_connect>, <mosquitto_connect_bind>
 *}
function mosquitto_connect_srv(mosq: Pmosquitto; const host: PAnsiChar; keepalive: cint; const bind_address: PAnsiChar): cint; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_publish(mosq: Pmosquitto; mid: pcint; const topic: PAnsiChar; payloadlen: cint; const payload: pointer; qos: cint; retain: cbool): cint; cdecl; external libmosq_NAME;
 ...
 * 	MOSQ_ERR_MALFORMED_UTF8 - if the topic is not valid UTF-8
 *}
function mosquitto_subscribe(mosq: Pmosquitto; mid: pcint; const sub: PAnsiChar; qos: cint): cint; cdecl; external libmosq_NAME;
 ...
 * 	MOSQ_ERR_MALFORMED_UTF8 - if the topic is not valid UTF-8
 *}
function mosquitto_unsubscribe(mosq: Pmosquitto; mid: pcint; const sub: PAnsiChar): cint; cdecl; external libmosq_NAME;
 ...
 *}
type
    Tpw_callback = function(buf: PAnsiChar; size: cint; rwflag: cint; userdata: pointer): cint; cdecl;

function mosquitto_tls_set(mosq: Pmosquitto;
		const cafile: PAnsiChar; const capath: PAnsiChar;
		const certfile: PAnsiChar; const keyfile: PAnsiChar;
 ...
 *	<mosquitto_tls_set>
 *}
function mosquitto_tls_opts_set(mosq: Pmosquitto; cert_reqs: cint; const tls_version: PAnsiChar; const ciphers: PAnsiChar): cint; cdecl; external libmosq_NAME;
 ...
 *	<mosquitto_tls_set>
 *}
function mosquitto_tls_psk_set(mosq: Pmosquitto; const psk: PAnsiChar; const identity: PAnsiChar; const ciphers: PAnsiChar): cint; cdecl; external libmosq_NAME;
 ...
 *}
type
    Ton_log_callback = procedure(mosq: Pmosquitto; obj: pointer; level: cint; const str: PAnsiChar); cdecl;
 ...
 *}
function mosquitto_socks5_set(mosq: Pmosquitto; const host: PAnsiChar; port: cint; const username: PAnsiChar; const password: PAnsiChar): cint; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_strerror(mosq_errno: cint): PAnsiChar; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_connack_string(connack_code: cint): PAnsiChar; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_sub_topic_tokenise(const subtopic: PAnsiChar; var topics: pPAnsiChar; count: pcint): cint; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_sub_topic_tokens_free(var topics: pPAnsiChar; count: cint): cint; cdecl; external libmosq_NAME;
 ...
 * 	MOSQ_ERR_NOMEM -   if an out of memory condition occurred.
 *}
function mosquitto_topic_matches_sub(const sub: PAnsiChar; const topic: PAnsiChar; result: pcbool): cint; cdecl; external libmosq_NAME;
function mosquitto_topic_matches_sub2(const sub: PAnsiChar; sublen: csize_t; const topic: PAnsiChar; topiclen: csize_t; result: pcbool): cint; cdecl; external libmosq_NAME;
 ...
 *}
function mosquitto_pub_topic_check(const topic: PAnsiChar): cint; cdecl; external libmosq_NAME;
function mosquitto_pub_topic_check2(const topic: PAnsiChar; topiclen: csize_t): cint; cdecl; external libmosq_NAME;
 ...
 *   <mosquitto_sub_topic_check>
 *}
function mosquitto_sub_topic_check(const topic: PAnsiChar): cint; cdecl; external libmosq_NAME;
function mosquitto_sub_topic_check2(const topic: PAnsiChar; topiclen: csize_t): cint; cdecl; external libmosq_NAME;
...
type
    Ttls_pw_callback = function(buf: PAnsiChar; size: cint; rwflag: cint; userdata: pointer): cint; cdecl;
 ...
 *}
function mosquitto_validate_utf8(const str: PAnsiChar; len: cint): cint; cdecl; external libmosq_NAME;
