...
resourcestring
  ...
  SNoPropertyInformation =
    'List does not implement IPropertyInformation interface.';
  SInvalidPropertyType = 'Property type not supported for property ''%s''';
  SNoPropertyValueInterface =
    'List item does not implement IPropertyValue interface.';
